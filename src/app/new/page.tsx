export default function Testing() {
    ...
    <div className="flex flex-col items-center pt-4">
        ...
        <form action="/api/v1/extension" method="POST" className="flex flex-col w-96">
            ...
            <input type="text" name="name" id="name" placeholder="JavaScript" className="p-1 pl-2 text-black rounded-lg" required />
            <br />
            <label htmlFor="gitUrl">Git url:</label>
            <input type="url" name="gitUrl" id="gitUrl" placeholder="https://github.com/extensio-editor/ext-js" className="p-1 pl-2 text-black rounded-lg" required />
            <br />
